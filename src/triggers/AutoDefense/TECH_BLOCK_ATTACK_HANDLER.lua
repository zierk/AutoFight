...
if not AutoDefense.TechAttackActive then
    AutoDefense.debug("Ignoring priority fallback for: " .. attack)
    return
end

AutoDefense.debug(attack .. " unavailable - trying next priority.")
